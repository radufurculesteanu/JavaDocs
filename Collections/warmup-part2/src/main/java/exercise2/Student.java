...
public class Student {
    ...
    public String toString() {
        return "ID: " + this.getId() + ", First name: " + this.getFirstName() + ", Last name: " + this.getLastName() + ", Averag grade: " + this.getAverageGrade();
    }
    ...
    public boolean equals(Object o) {
        ...
        else
        {
            ...
            else
            {
                ...
                if(this.id.equals(other.id) && this.firstName.equals(other.firstName) && this.lastName.equals(other.lastName) && this.averageGrade.equals(other.averageGrade))
                    return true;
            }
        }
    ...
    public int hashCode() {
        ...
        result += this.id.hashCode() + this.firstName.hashCode() + this.lastName.hashCode() + this.averageGrade.hashCode();
        return result;
    }
