...
public class Student {
    ...
    public String toString() {
        return "ID: " + this.id + ", First name: " + this.firstName + ", Last Name: " + this.lastName + ", Avg. grade: " + this.averageGrade;
    }
        ...
        // TODO Exercise 2 c1) Check if the current instance is the same instance as the one from Object o
            ...
            if(o == null)
                ...
                if(o.getClass().equals(this.getClass()))
                {
                    ...
                    {
                        if(this.id.equals(other.id) && this.firstName.equals(other.firstName) && this.lastName.equals(other.lastName)
                                && this.averageGrade.equals(other.averageGrade))
                            return true;
                    }
                }
